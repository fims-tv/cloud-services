...
var REST_API_LAMBDA_PACKAGE_FILE = "./build/dynamo-to-elasticsearch.zip";
...
function createRestApiLambdaPackage(callback) {
    ...
    archive.file("dynamo-to-elasticsearch.js");
    archive.directory("node_modules/elasticsearch/");
    archive.directory("node_modules/http-aws-es/");
    archive.directory("node_modules/moment/");
    archive.directory("node_modules/underscore/");
    archive.directory("node_modules/when/");
