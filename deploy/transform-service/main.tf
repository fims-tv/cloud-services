...
resource "aws_lambda_function" "transform_worker_lambda" {
...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:${var.region}:${var.account_id}:${aws_api_gateway_rest_api.transform_service_api.id}/*/${aws_api_gateway_method.transform_service_api_method.http_method}/*"
}
...
resource "aws_api_gateway_deployment" "transform_service_deployment" {
  ...
  variables = {
    ...
    "PublicUrl"                = "https://${aws_api_gateway_rest_api.transform_service_api.id}.execute-api.${var.region}.amazonaws.com/${var.restApiStageName}"
...
output "rest_service_url" {
  value = "https://${aws_api_gateway_deployment.transform_service_deployment.rest_api_id}.execute-api.${var.region}.amazonaws.com/${aws_api_gateway_deployment.transform_service_deployment.stage_name}"
}
