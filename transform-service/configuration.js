...
module.exports = {
    deployConfig: function () {
        ...
        if (fs.existsSync(DEPLOY_CONFIG_FILE)) {
            ...
            console.error("{");
            console.error("  \"lambdaExecutionRoleName\": \"fims-transform-lambda-execution-role\",");
            console.error("  \"restApiLambdaFunctionName\": \"fims-transform-rest-api\",");
            console.error("  \"workerLambdaFunctionName\": \"fims-transform-worker\",");
            console.error("  \"restApiName\": \"fims-transform-rest-api\",");
