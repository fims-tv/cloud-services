...
function retrieveEssenceFromMediaRepo(essenceIdUrl) {
    ...
    //Get the BMEssence from Media Repo
...
function postEssenceToSemanticRepo(err, response, body) {
    ...
    //Create the BMEssence in Semantic Repo
    request({                              
...
//if (fs.existsSync(CREDENTIALS_FILE)) {
    ...
    exports.handler = (event, context, callback) => {
        ...
        var payload;
        var worflow_param = event.worflow_param;
        ...
        async.waterfall([
            ...
            function (callback) {
				...
				//Create the BMContent in Media Repo
				request({                              
					url: worflow_param.assetID,
					method: "GET",
					headers: { "Content-Type": "application/json" }
			...
			function (response, body, callback) {
				...
				var bmObj = payload;
				console.log('POST to ' + REPO_URL_BMCONTENT);
				//Create the BMContent in Semantic Repo
				request({                              
					url: REPO_URL_BMCONTENT,
					method: "POST",
					headers: { "Content-Type": "application/json" },
