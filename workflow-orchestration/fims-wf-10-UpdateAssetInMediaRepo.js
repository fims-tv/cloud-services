...
function AddEssenceToBMContent(bmcObj, essenceID) {
    ...
    if (bmcObj["ebucore:hasRelatedResource"] == undefined) {
        ...
        if (Array.isArray(bmcObj["ebucore:hasRelatedResource"]) == false) {
           if ( bmcObj["ebucore:hasRelatedResource"].id == undefined) {
                bmcObj["ebucore:hasRelatedResource"] = [];
           } 
           else
           {
               var tempValue = bmcObj["ebucore:hasRelatedResource"].id;
               bmcObj["ebucore:hasRelatedResource"] = [];
               bmcObj["ebucore:hasRelatedResource"].push ({"id": tempValue });
           }
        }
    }
