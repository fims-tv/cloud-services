...
// Display type for object : Object.prototype.toString.call(event)   
// Display properties of object   Object.prototype.keys or  Object.keys(event)
            

//var movie = JSON.parse(new Buffer(event).toString("utf8"));
