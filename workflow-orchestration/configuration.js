...
module.exports = {
    deployConfig: function () {
        ...
        if (fs.existsSync(DEPLOY_CONFIG_FILE)) {
            ...
            console.error("{");
            console.error('"workflowExecutionRoleName":"fims-ame-workflow-execution-role"');
            console.error('"stepFunctionStateMachine":"fims-demo-SM1"');
            console.error('"workflowStateMachineFileName":"fims-state-machine.json"');
            console.error("}");
            process.exit(1);
        }
    },
