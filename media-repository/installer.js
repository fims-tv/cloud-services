...
var FIMS_AME_API_PACKAGE_FILE = "./build/fims-media-repo-api-package.zip";
var FIMS_AME_PROCESSOR_PACKAGE_FILE = "./build/fims-media-repo-process-package.zip";
...
function createFimsAmeApiPackage(callback) {
    ...
    archive.file("fims-repo-rest-api.js");
    archive.file("fims-media-repository.js");
        ...
        function (data, callback) {
            ...
            if (func) {
                ...
                var params = {
                    ...
                    FunctionName: config.lambdaApiFunctionName,
                    Handler: "fims-repo-rest-api.handler",
