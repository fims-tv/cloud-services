...
module.exports = {
    deployConfig: function () {
        ...
        if (fs.existsSync(DEPLOY_CONFIG_FILE)) {
            ...
            console.error("{");
            console.error("  \"tableName\": \"media-repo\",");
            console.error("  \"lambdaExecutionRoleName\": \"fims-media-repo-lambda-execution-role\",");
            console.error("  \"lambdaApiFunctionName\": \"fims-media-repo-api-lambda-function\",");
            console.error("  \"restApiName\": \"fims-media-repo-rest-api\",");
